...
- Downloads and verifies the official `unreal-agent-runner` release on first use, with a visible status line and actionable setup errors.
...
- Housekeeping: old logs, job output, sessions and images are pruned automatically.
